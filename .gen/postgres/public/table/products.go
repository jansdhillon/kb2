...
func newProductsTableImpl(schemaName, tableName, alias string) productsTable {
	var (
		...
		allColumns        = postgres.ColumnList{IDColumn, ActiveColumn, NameColumn, DescriptionColumn, ImageColumn, MetadataColumn, BookIDColumn}
		mutableColumns    = postgres.ColumnList{ActiveColumn, NameColumn, DescriptionColumn, ImageColumn, MetadataColumn, BookIDColumn}
		defaultColumns    = postgres.ColumnList{}
	)
